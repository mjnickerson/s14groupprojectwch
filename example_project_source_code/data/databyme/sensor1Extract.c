/*
gcc -o sensor1Extract sensor1Extract.c -lm
*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
int main()
{
    ...
    ifile_name = "motion_data_output_1.csv";
	/* open the input file */
	printf(" Input file \'%s\'.\n", ifile_name);
	...
	float accex1 = find_minumum(x, N_SAMPLES);
	float accey1 = find_minumum(y, N_SAMPLES);
	float gyrox1 = find_maximum(gx, N_SAMPLES);
	fclose(fp);
	...
	float gyrox2 = find_maximum(gx, N_SAMPLES);
